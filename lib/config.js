...
// Priority: --workspace flag > HAL_PROJ_MGR_MASTER_WORKSPACE env > cwd
// ---------------------------------------------------------------------------
function resolveWorkspace(args) {
  ...
  if (process.env.HAL_PROJ_MGR_MASTER_WORKSPACE) return path.resolve(process.env.HAL_PROJ_MGR_MASTER_WORKSPACE);
  return process.cwd();
}
...
// Priority: HAL_PROJ_MGR_MASTER_WORKSPACE env > cwd
// ---------------------------------------------------------------------------
